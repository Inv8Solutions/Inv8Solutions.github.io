...
<template>
  <div class="sticky top-0 z-50 w-full border-b border-white/[0.07] bg-white/[0.04] backdrop-blur-2xl" style="box-shadow: 0 1px 40px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.06);">
